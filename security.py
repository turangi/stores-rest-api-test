...
def authenticate(username, password):
    ...
    :param password: User's un-crypted password in string format.
...
def identity(payload):
    """
    Function that gets called when user has already aauthenticated, and Flask-JWT
    verified their authorization header is correct.
    :param payload: A dictioinary with 'identity' key, which is the user id.
